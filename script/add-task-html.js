...
function subtaskListInnerHTML(i, subtasks) {
    ...
    return (
        `
        <li id="add-task-subtask-list-item${i}" onclick="openEditAddedSubtask(${i}, ${subtasks[i].id})"  onmouseenter="removeDisplayNone(${i})" onmouseleave="addDisplayNone(${i})">
        <span>${subtasks[i].text}</span>
        <div id="add-task-subtask-list-buttons${i}" class="d-none">
            <img onclick="openEditAddedSubtask(${i}, ${subtasks[i].id})" src="/assets/img/add-task/subtask-edit.png" alt="" height="24px" width="24px">
            <div class="hr"></div>
            <img onclick="deleteAddedSubtask(${i}, ${subtasks[i].id})" src="/assets/img/add-task/subtask-delete.png" alt="" height="24px" width="24px">
        </div>
        </li>
        ...
        <div class="d-none subtask-edit-input-container" id="add-task-edit-input-container${i}">
            ...
            <div>
                <img onclick="deleteAddedSubtask(${i}, ${subtasks[i].id})" src="/assets/img/add-task/subtask-delete.png" alt="" height="24px" width="24px">
                <div class="hr"></div>
                <img onclick="confirmEditSubtask(${i}, ${subtasks[i].id})"src="/assets/img/add-task/subtask-check.png" alt="" height="24px" width="24px">
            </div>
        </div>
